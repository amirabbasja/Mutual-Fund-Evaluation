...
<img src="https://latex.codecogs.com/svg.image?\frac{MAX(Total\:cost\:of\:opening\:positions,Total\:revenue\:from\:closing\:positions)}{AVG(Fund\:AuM\:in\:the\:reporting\:period)}" alt = "Formula">
